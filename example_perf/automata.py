...
def main(urd):
	...
	print()
	ix = [x.method for x in urd.joblist].index('csvimport')
	print("Total running time             %10.3f" %(profile_jobs(urd.joblist),))
	print("Total test time                %10.3f" %(profile_jobs(urd.joblist[ix:]),))
	print()
